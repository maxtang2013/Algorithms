...
public:
    bool isPalindrome(string s) {
        ...
        while (i < j) {
            ...
            if ( !(isdigit(s[j]) || isupper(s[j]) || islower(s[j])) ) {
                --j;
                continue;
            }
...
{
    Solution sln;
    cout << sln.isPalindrome("ab") << endl;
    
    cout << sln.isPalindrome("a") << endl;
    
    cout << sln.isPalindrome("aba") << endl;
    cout << sln.isPalindrome("-a, c,++c,a***") << endl;
    
    cout << sln.isPalindrome("") << endl;
    
    cout << sln.isPalindrome("care ** a rac") << endl;
}
